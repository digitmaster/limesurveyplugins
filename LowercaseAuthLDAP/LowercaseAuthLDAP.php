...
class LowercaseAuthLDAP extends ls\pluginmanager\AuthPluginBase
{
    protected $storage = 'DbStorage';

    static protected $description = 'Provides Lowercase LDAP user creation and authentication';
    static protected $name = 'LowercaseAuthLDAP';
    ...
    */
    ...
    public function newUserSession()
    {
        ...
        if ($identity->plugin != 'LowercaseAuthLDAP')
        {
            return;
        }
